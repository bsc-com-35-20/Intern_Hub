...
class PostInternship extends StatefulWidget {
  const PostInternship({super.key});
...
class _PostInternshipState extends State<PostInternship> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Post Internship Opportunity'),
    ...
    return Align(
      ...
      child: ElevatedButton(
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content: const Text('Internship opportunity posted successfully!'),
                    actions: [
                      TextButton(
                        child: const Text('OK'),
                        onPressed: () {
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: Colors.teal,
          padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 16), // Adjust padding
