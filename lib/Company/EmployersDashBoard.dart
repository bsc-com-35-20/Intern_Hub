...
class ManageInternship extends StatelessWidget {
  Future<List<Map<String, dynamic>>> fetchApplications(String internshipId, String category) async {
  ...
  void showApplications(BuildContext context, String internshipId, String category) async {
  ...
  Widget _buildInternshipCard(String title, String status, String internshipId, String category, BuildContext context) {
    return Card(
      elevation: 5,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(15),
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 16),
            _buildInternshipCard('Software Development Intern', 'In Progress', 'internshipId1', 'Software', context),
            _buildInternshipCard('Marketing Intern', 'Completed', 'internshipId2', 'Marketing', context),
            _buildInternshipCard('Data Science Intern', 'In Progress', 'internshipId3', 'Data Science', context),
          ],
        ),
      ),
    );
